...
export default({
    ...
    methods: {
        ...
        submit () {
            axios.post('/dados', {
                ...
                base_dados: this.form.base_dados
            })
                .then(response => {
                    this.close()
                    this.$swal.fire({
    ...
    computed: {
        isReadyToSubmit () {
            return this.form.categoria !== null &&
                this.form.desc !== '' &&
                this.form.tempo !== '' &&
                this.form.fonte !== null && (
                    (this.form.fonte !== 0 && this.form.base_dados === null) ||
                    (this.form.fonte === 0 && this.form.base_dados !== null)
                )
        }
    }
